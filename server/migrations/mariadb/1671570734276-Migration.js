...
module.exports = class Migration1671570734276 {
    name = 'Migration1671570734276'

    async up(queryRunner) {
const { dbname } = (await queryRunner.query("SELECT DATABASE() AS `dbname`"))[0];
        await queryRunner.query(`CREATE TABLE \`GoogleCalendarCreatedEvent\` (\`MeetingID\` int NOT NULL, \`UserID\` int NOT NULL, \`CreatedGoogleMeetingID\` varchar(255) NOT NULL, INDEX \`IDX_5fb0315e585fd420c48fe19ec8\` (\`UserID\`), PRIMARY KEY (\`MeetingID\`, \`UserID\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`CREATE TABLE \`MicrosoftCalendarCreatedEvent\` (\`MeetingID\` int NOT NULL, \`UserID\` int NOT NULL, \`CreatedMicrosoftMeetingID\` varchar(255) NOT NULL, INDEX \`IDX_11dcd204e07423d2d30750c67a\` (\`UserID\`), PRIMARY KEY (\`MeetingID\`, \`UserID\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`ALTER TABLE \`GoogleCalendarCreatedEvent\` ADD CONSTRAINT \`FK_43da565eecb2453a59a9218aa57\` FOREIGN KEY (\`MeetingID\`) REFERENCES \`Meeting\`(\`ID\`) ON DELETE CASCADE ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE \`MicrosoftCalendarCreatedEvent\` ADD CONSTRAINT \`FK_068c32fdb6addc8ba39404ce693\` FOREIGN KEY (\`MeetingID\`) REFERENCES \`Meeting\`(\`ID\`) ON DELETE CASCADE ON UPDATE NO ACTION`);
...
const { dbname } = (await queryRunner.query("SELECT DATABASE() AS `dbname`"))[0];
        ...
        await queryRunner.query(`ALTER TABLE \`MicrosoftCalendarCreatedEvent\` DROP FOREIGN KEY \`FK_068c32fdb6addc8ba39404ce693\``);
        ...
        await queryRunner.query(`ALTER TABLE \`GoogleCalendarCreatedEvent\` DROP FOREIGN KEY \`FK_43da565eecb2453a59a9218aa57\``);
