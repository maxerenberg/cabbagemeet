...
module.exports = class Migration1671570734276 {
    ...
    async up(queryRunner) {
        await queryRunner.query(`CREATE TABLE "GoogleCalendarCreatedEvent" ("MeetingID" integer NOT NULL, "UserID" integer NOT NULL, "CreatedGoogleMeetingID" varchar NOT NULL, PRIMARY KEY ("MeetingID", "UserID"))`);
        ...
        await queryRunner.query(`CREATE TABLE "MicrosoftCalendarCreatedEvent" ("MeetingID" integer NOT NULL, "UserID" integer NOT NULL, "CreatedMicrosoftMeetingID" varchar NOT NULL, PRIMARY KEY ("MeetingID", "UserID"))`);
        ...
        await queryRunner.query(`CREATE TABLE "temporary_GoogleCalendarCreatedEvent" ("MeetingID" integer NOT NULL, "UserID" integer NOT NULL, "CreatedGoogleMeetingID" varchar NOT NULL, CONSTRAINT "FK_43da565eecb2453a59a9218aa57" FOREIGN KEY ("MeetingID") REFERENCES "Meeting" ("ID") ON DELETE CASCADE ON UPDATE NO ACTION, CONSTRAINT "FK_5fb0315e585fd420c48fe19ec8e" FOREIGN KEY ("UserID") REFERENCES "GoogleOAuth2" ("UserID") ON DELETE CASCADE ON UPDATE NO ACTION, PRIMARY KEY ("MeetingID", "UserID"))`);
        await queryRunner.query(`INSERT INTO "temporary_GoogleCalendarCreatedEvent"("MeetingID", "UserID", "CreatedGoogleMeetingID") SELECT "MeetingID", "UserID", "CreatedGoogleMeetingID" FROM "GoogleCalendarCreatedEvent"`);
        ...
        await queryRunner.query(`CREATE TABLE "temporary_MicrosoftCalendarCreatedEvent" ("MeetingID" integer NOT NULL, "UserID" integer NOT NULL, "CreatedMicrosoftMeetingID" varchar NOT NULL, CONSTRAINT "FK_068c32fdb6addc8ba39404ce693" FOREIGN KEY ("MeetingID") REFERENCES "Meeting" ("ID") ON DELETE CASCADE ON UPDATE NO ACTION, CONSTRAINT "FK_11dcd204e07423d2d30750c67af" FOREIGN KEY ("UserID") REFERENCES "MicrosoftOAuth2" ("UserID") ON DELETE CASCADE ON UPDATE NO ACTION, PRIMARY KEY ("MeetingID", "UserID"))`);
        await queryRunner.query(`INSERT INTO "temporary_MicrosoftCalendarCreatedEvent"("MeetingID", "UserID", "CreatedMicrosoftMeetingID") SELECT "MeetingID", "UserID", "CreatedMicrosoftMeetingID" FROM "MicrosoftCalendarCreatedEvent"`);
    ...
    async down(queryRunner) {
        ...
        await queryRunner.query(`CREATE TABLE "MicrosoftCalendarCreatedEvent" ("MeetingID" integer NOT NULL, "UserID" integer NOT NULL, "CreatedMicrosoftMeetingID" varchar NOT NULL, PRIMARY KEY ("MeetingID", "UserID"))`);
        await queryRunner.query(`INSERT INTO "MicrosoftCalendarCreatedEvent"("MeetingID", "UserID", "CreatedMicrosoftMeetingID") SELECT "MeetingID", "UserID", "CreatedMicrosoftMeetingID" FROM "temporary_MicrosoftCalendarCreatedEvent"`);
        ...
        await queryRunner.query(`CREATE TABLE "GoogleCalendarCreatedEvent" ("MeetingID" integer NOT NULL, "UserID" integer NOT NULL, "CreatedGoogleMeetingID" varchar NOT NULL, PRIMARY KEY ("MeetingID", "UserID"))`);
        await queryRunner.query(`INSERT INTO "GoogleCalendarCreatedEvent"("MeetingID", "UserID", "CreatedGoogleMeetingID") SELECT "MeetingID", "UserID", "CreatedGoogleMeetingID" FROM "temporary_GoogleCalendarCreatedEvent"`);
