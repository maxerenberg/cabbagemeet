...
module.exports = class Migration1671570734276 {
    ...
    async up(queryRunner) {
        await queryRunner.query(`CREATE TABLE "googlecalendarcreatedevent" ("meetingid" integer NOT NULL, "userid" integer NOT NULL, "createdgooglemeetingid" character varying NOT NULL, CONSTRAINT "pk_9c558b276881a138b8f312e0361" PRIMARY KEY ("meetingid", "userid"))`);
        ...
        await queryRunner.query(`CREATE TABLE "microsoftcalendarcreatedevent" ("meetingid" integer NOT NULL, "userid" integer NOT NULL, "createdmicrosoftmeetingid" character varying NOT NULL, CONSTRAINT "pk_7516801a4bb58c87de178316a8d" PRIMARY KEY ("meetingid", "userid"))`);
        ...
        await queryRunner.query(`ALTER TABLE "googlecalendarcreatedevent" ADD CONSTRAINT "fk_2c1863808a431dc656ec5109c8f" FOREIGN KEY ("meetingid") REFERENCES "meeting"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "microsoftcalendarcreatedevent" ADD CONSTRAINT "fk_574197d31d7698e321b08f59aa9" FOREIGN KEY ("meetingid") REFERENCES "meeting"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    ...
    async down(queryRunner) {
        ...
        await queryRunner.query(`ALTER TABLE "microsoftcalendarcreatedevent" DROP CONSTRAINT "fk_574197d31d7698e321b08f59aa9"`);
        ...
        await queryRunner.query(`ALTER TABLE "googlecalendarcreatedevent" DROP CONSTRAINT "fk_2c1863808a431dc656ec5109c8f"`);
