...
module.exports = class Migration1672038966530 {
    ...
    async up(queryRunner) {
        ...
        await queryRunner.query(`ALTER TABLE "microsoftcalendarcreatedevent" ADD CONSTRAINT "fk_0ef4d32bc094fd9da0f043e4317" FOREIGN KEY ("respondentid") REFERENCES "meetingrespondent"("respondentid") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "googlecalendarcreatedevent" ADD CONSTRAINT "fk_391b9705eb024e5c282fa4de2df" FOREIGN KEY ("respondentid") REFERENCES "meetingrespondent"("respondentid") ON DELETE NO ACTION ON UPDATE NO ACTION`);
